...
export class createUsersPlacesTable1651444850877 implements MigrationInterface {
    name = 'createUsersPlacesTable1651444850877'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`role\` enum ('driver', 'hero', 'agency', 'client', 'client-manager', 'none') NOT NULL DEFAULT 'none', \`name\` varchar(255) NOT NULL, \`email\` varchar(255) NULL, \`isp\` enum ('naver', 'kakao', 'apple', 'none') NULL DEFAULT 'none', \`ispId\` varchar(255) NULL, \`ispProfileImage\` varchar(255) NULL, \`coord\` text NULL, \`location\` point NOT NULL, INDEX \`IDX_ace513fa30d485cfd25c11a9e4\` (\`role\`), INDEX \`IDX_4c3e3d228df59494b17a273842\` (\`isp\`), INDEX \`IDX_c327f19d7924f50a243a41a747\` (\`ispId\`), SPATIAL INDEX \`IDX_15b3fe608b52f34df363512e39\` (\`location\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
